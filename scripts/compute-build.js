...
const entrypoints = {
    classic: [...common, 'data/gear', 'data/enchants', 'data/levelstats', 'data/buffs', 'data/spells',
        'data/talents', 'data/talents_forever', 'talent-rules', 'racial-rules', 'data/session', 'globals', 'settings', 'profile-validation', 'profiles', 'stats', 'ui'],
    forever: [...common, 'data/gear_forever', 'data/enchants', 'data/levelstats', 'data/buffs', 'data/spells',
        'data/talents', 'data/talents_forever', 'talent-rules', 'racial-rules', 'data/session_forever', 'data/presets_forever', 'globals', 'settings', 'profile-validation', 'profiles', 'stats', 'ui'],
};
