...
spells.push({id: 'forever:elunes-light', name: 'Elune’s Light', classname: 'ElunesLight',
    ...
    timetostart: 0, timetostartactive: true, timetoend: 16, timetoendactive: false,
...
var foreverRacialDescriptions = {
    ...
    'Night Elf': 'Elune’s Light: +10% crit for 15 seconds; enable it in Rotation. Quickness affects dodge and movement, outside the DPS model.',
    Gnome: 'Expansive Mind: +5% maximum rage, including Boundless Rage. Eureka!: empowers your next three abilities; enable it in Rotation. 40% lower rage costs, 2-minute cooldown.',
    Orc: 'Axe Specialization: +1% crit for axe autoattacks and abilities, plus spell crit while an axe is equipped. Blood Fury: +10% attack/spell power for 15 seconds; enable it in Rotation.',
    ...
    Troll: 'Beast Slaying: +5% damage to Beasts. Berserking: +10% haste for 10 seconds; enable it in Rotation.',
