class Player {
    ...
    stepauras(nobleeds) {
        ...
        if (this.auras.majorfrenzypotion && this.auras.majorfrenzypotion.timer) this.auras.majorfrenzypotion.step();
    ...
    endauras() {
        ...
        if (this.auras.majorfrenzypotion && this.auras.majorfrenzypotion.timer) this.auras.majorfrenzypotion.end();
